      ...
      <Form method="POST">
        ...
        <div className="mb-12 flex items-center gap-5">
          <input
            ...
            name="priority"
            id="priority"
            className="h-6 w-6 accent-blue-600 focus:outline-none focus:ring focus:ring-blue-600 focus:ring-offset-2"
            // value={withPriority}
...
export const createOrderAction = async ({ request }) => {
  ...
  if (!isValidPhone(order.phone)) {
    errors.phone = "Please Enter Validate Phone Number.";
  }
